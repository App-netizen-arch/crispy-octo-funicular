...
import {
  compile
} from "./chunk-ML22LMDS.js";
import "./chunk-ZWGPOGXD.js";
import "./chunk-TOG2N6CE.js";
import {
  __commonJS,
  __toESM
} from "./chunk-KJNWX5LL.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-SAY755NK.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-B7JBIT2V.js")).default;
  return {

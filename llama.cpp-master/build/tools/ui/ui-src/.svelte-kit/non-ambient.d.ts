...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/(chat)" | "/" | "/(chat)/chat" | "/(chat)/chat/[id]" | "/mcp-servers" | "/search" | "/settings" | "/settings/[[section]]";
		RouteParams(): {
			"/(chat)/chat/[id]": { id: string };
			"/settings/[[section]]": { section?: string | undefined }
		};
		LayoutParams(): {
			"/(chat)": { id?: string | undefined };
			"/": { id?: string | undefined; section?: string | undefined };
			"/(chat)/chat": { id?: string | undefined };
			"/(chat)/chat/[id]": { id: string };

import CJS_COMPAT_NODE_URL_qruzvwlaofa from 'node:url';
import CJS_COMPAT_NODE_PATH_qruzvwlaofa from 'node:path';
import CJS_COMPAT_NODE_MODULE_qruzvwlaofa from "node:module";

var __filename = CJS_COMPAT_NODE_URL_qruzvwlaofa.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_qruzvwlaofa.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_qruzvwlaofa.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-KJNWX5LL.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-SAY755NK.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-B7JBIT2V.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-C4QBPO5J.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
